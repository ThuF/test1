...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'test.Entities.Customer.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('test.Entities.Customer.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../services/v4/js/test/api/Entities/Customer.js';
